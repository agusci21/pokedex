...
import 'common/http_helper_mock.mocks.dart';
void main() async {
  final MockIHttpHelper mockHttpHelper =  MockIHttpHelper();
  final PokemonRepository repository = PokemonRepository(baseUrl: 'https://test_url', httpHelper: mockHttpHelper);

  group('Will test Pokemon repository at getting data ', () {
    const input = GetPokemonByIdInput(id: '1');
    ...
    "weight": 69
      ...
      final output = await repository.getPokemonById(input);
      expect(output.pokemon, isNotNull);

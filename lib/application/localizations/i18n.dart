...
class I18n {
  ...
  Future<String> _loadData() async {
    try {
      return await rootBundle.loadString('assets/i18n/${_locale.languageCode}.json');
    } catch (_) {
      return await rootBundle.loadString('assets/i18n/${EnvironmentConfig.defaultLanguage}.json');
    }
  }
...
class AppLocalizationsDelegate extends LocalizationsDelegate<I18n> {
  ...
  bool isSupported(Locale locale) {
    return Locales.suportedLanguages.map((e) => e.languageCode).contains(locale.languageCode);
  }
